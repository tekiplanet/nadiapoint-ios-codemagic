...
class FiatWithdrawalSuccessScreen extends StatelessWidget {
  final Map<String, dynamic> withdrawal;
  final Map<String, dynamic> summary;

  const FiatWithdrawalSuccessScreen({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    final transactionId = withdrawal['transactionId'] ?? 'N/A';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Withdraw Again'),
